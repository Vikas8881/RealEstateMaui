...
namespace RealEstateApi.Data
{
    public class ApiDbContext : DbContext
    {
        ...
        {
          optionsBuilder.UseSqlServer(@"Data Source=SQL5102.site4now.net;Initial Catalog=db_a81ce0_realstate;User Id=db_a81ce0_realstate_admin;Password=Urmylifeak@0607;");
        }
